...
#### `imx-4.1-krogoth` lzop gcc-6 patch
[source,console]
$: git -C sources/poky/meta checkout 4515fc952963e233d5f24bb319028e8c68ee7622

https://github.com/openembedded/openembedded-core/tree/master/meta/recipes-support/lzop[lzop gcc-6 patch]
