...
1. the U-Boot boot script / environment that launches `bootaa64.efi`
2. the generated `hab_auth_img.cmd`
3. the exact binary layout of `Image.kgrub.signed`
4. the exact binary layout of `bootaa64.efi.signed`
5. any U-Boot config related to EFI binary verification or secure EFI boot
